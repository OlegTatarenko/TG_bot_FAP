...
const (
	...
	ManagerID   = 47526499                    // MenedgerID переменная с id офис-менеджера в телеграм
)
...
// MenedgerID переменная с id офис-менеджера в телеграм
//var ManagerID int64 = 47526499
